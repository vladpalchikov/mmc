...
<div class="page center-block">
    <div class="document-head text-center">
        ...
        <span class="form-header">об оформлении патента</span><br>
        @if (Auth::user()->mmc)
    ...
    <div class="form-content">
        ...
        <div class="first-line">
            <span>Прошу выдать патент для осуществления трудовой деятельности</span>
        </div>
        <div class="form-section">
            <span class="row-title">Фамилия:</span>
            <ul>
				{!! FormOutput::string($patent->surname, 37) !!}
            </ul>
        </div>
        <div class="form-section">
            <span class="row-title">Имя:</span>
            <ul>
				{!! FormOutput::string($patent->name, 37) !!}
            </ul>
        </div>
        <div class="form-section">
            ...
            <ul>
				{!! FormOutput::string($patent->middle_name, 37) !!}
            </ul>
        </div>
        <div class="form-section">
...
@for ($i = 0; $i < 42-mb_strlen(mb_substr($patent->name_change, 29)); $i++)<li></li>@endfor
        ...
        <div class="form-section section-offset">
            ...
            <ul>
				{!! FormOutput::string($patent->nationality, 31) !!}
            </ul>
        </div>
        <div class="form-section">
            <ul>
				{!! FormOutput::string($patent->nationality_line2, 42) !!}
            </ul>
        </div>
        <div class="form-section section-offset">
        ...
        <div class="short-form-section section-offset">
	        ...
	        <ul class="short-table-qualification day">
                {!! FormOutput::day($patent->birthday) !!}
            </ul>
            <ul class="short-table-qualification month">
                {!! FormOutput::month($patent->birthday) !!}
            </ul>
            <ul class="short-table-qualification year">
                {!! FormOutput::year($patent->birthday) !!}
            </ul>
            <span class="row-title">Пол:</span>
            <ul>
                <li>@if (!$patent->gender) X @endif</li>
            </ul>
        ...
        <div class="form-section">
            ...
            <ul>
				{!! FormOutput::string($patent->document_name, 26) !!}
            </ul>
        </div>
        <div class="short-form-section section-offset">
            <span class="row-title">серия</span>
            <ul class="short-table-qualification">
				{!! FormOutput::string($patent->document_series, 8) !!}
            </ul>
            <span class="row-title">№</span>
            <ul class="short-table-qualification">
            	{!! FormOutput::string($patent->document_number, 11) !!}
            </ul>
            <span class="row-title print-size">Дата выдачи</span>
            <ul class="short-table-qualification day">
                {!! FormOutput::day($patent->document_date) !!}
            </ul>
            <ul class="short-table-qualification month">
                {!! FormOutput::month($patent->document_date) !!}
            </ul>
            <ul class="short-table-qualification year last-item">
                {!! FormOutput::year($patent->document_date) !!}
            </ul>
        </div>
        <div class="form-section">
        ...
        <div class="short-form-section section-offset">
            <span class="row-title">Серия и номер<br>миграционной карты:&nbsp;</span>
            <ul class="short-table-qualification">
        ...
        <div class="form-section">
            ...
            <ul>
				{!! FormOutput::string($patent->address, 26) !!}
            </ul>
        </div>
        <div class="form-section">
            <ul>
            	{!! FormOutput::string($patent->address_line2, 43) !!}
            </ul>
        </div>
        <div class="form-section">
            <ul>
            	{!! FormOutput::string($patent->address_line3, 43) !!}
            </ul>
        </div>
        <div class="short-form-section section-offset">
        ...
        <div><span>Сведения о ранее выданном патенте (заполняется в случае получения патента для осуществления трудовой деятельности на территории другого субъекта Российской Федерации):</span></div>
        <div class="form-section section-offset">
        ...
        <div class="form-section">
            ...
            <ul>
				{!! FormOutput::string($patent->phone, 30) !!}
            </ul>
        </div>
        <div class="check-section">
