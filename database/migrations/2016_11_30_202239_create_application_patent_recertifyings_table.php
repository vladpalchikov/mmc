...
class CreateApplicationPatentRecertifyingsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('application_patent_recertifyings', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->text('registration_address_line2')->nullable();
            ...
            $table->text('russian_document_line2')->nullable();
            ...
            $table->text('profession_line2')->nullable();

            $table->date('work_until')->nullable();

            $table->text('prev_patent')->nullable();
            $table->text('prev_patent_line2')->nullable();
    ...
    {
        Schema::drop('application_patent_recertifyings');
    }
}
